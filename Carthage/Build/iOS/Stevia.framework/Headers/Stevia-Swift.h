...
///
/// Essentially a shortcut for <code>setTitle("MyText", forState: .Normal)
/// </code>
///
...
///
/// Essentially a shortcut for <code>setTitle(NSLocalizedString("MyText", comment: "") , forState: .Normal)
/// </code>
///
/// \returns  Itself for chaining purposes
...
///
/// Essentially a shortcut for <code>setImage(UIImage(named:"X"), forState: .Normal)
/// </code>
///
/// \returns  Itself for chaining purposes
...
/// 
/// </code>
/// <code>- Returns: Itself for chaining purposes
/// 
/// </code>
...
///
/// Esentially, this is just a shortcut to <code>contentView.addSubview
/// </code>
/// and 'translatesAutoresizingMaskIntoConstraints = false'
///
/// <code>class PhotoCollectionViewCell: UICollectionViewCell {
/// 
...
///
/// Essentially a shortcut for <code>image = UIImage(named: "X")
/// </code>
///
/// \returns  Itself for chaining purposes
...
/// Sets the label localization key but in a chainable fashion Essentially a shortcut for text = NSLocalizedString("X", comment: "")
///
/// \returns  Itself for chaining purposes
- (nonnull instancetype)textKey:(NSString * _Nonnull)t;
@end
...
/// and 'translatesAutoresizingMaskIntoConstraints = false'
///
/// <code>class NotificationCell: UITableViewCell {
/// 
///    var avatar = UIImageView()
///    var name = UILabel()
///    var followButton = UIButton()
...
/// Defines the view hierachy for the view.
///
/// Esentially, this is just a shortcut to <code>addSubview
/// </code>
/// and 'translatesAutoresizingMaskIntoConstraints = false'
///
...
/// Makes a view follow another view's frame. For instance if we want a button to be on top of an image :
///
/// <code>button.followEdges(image)
/// 
/// </code>
- (void)followEdges:(UIView * _Nonnull)otherView;

/// Enforce a view to keep height and width equal at all times, essentially forcing it to be a square.
///
/// <code>image.heightEqualsWidth()
/// 
/// </code>
...
///
/// <code>button.centerHorizontally()
/// 
/// </code>
/// \returns  Itself, enabling chaining,
...
///
/// <code>button.centerHorizontally(40)
/// 
/// </code>
/// \returns  Itself, enabling chaining,
...
///
/// <code>button.centerVertically(40)
/// 
/// </code>
/// \returns  Itself, enabling chaining,
...
/// Adds the constraints needed for the view to fill its superview. A padding can be used to apply equal spaces between the view and its superview
- (void)fillContainer:(CGFloat)padding;
- (UIView * _Nonnull)fillVWithM:(CGFloat)points;

/// Adds the constraints needed for the view to fill its superview Vertically. A padding can be used to apply equal spaces between the view and its superview
- (UIView * _Nonnull)fillVerticallyWithM:(CGFloat)points;
- (UIView * _Nonnull)fillHWithM:(CGFloat)points;

/// Adds the constraints needed for the view to fill its superview Horizontally. A padding can be used to apply equal spaces between the view and its superview
...
///
/// <code>label.leftConstraint?.constant = 10
///  
/// // Animate if needed
...
///
/// <code>label.rightConstraint?.constant = 10
///  
/// // Animate if needed
/// UIView.animateWithDuration(0.3, animations:layoutIfNeeded)
/// 
...
///
/// <code>label.topConstraint?.constant = 10
///  
/// // Animate if needed
/// UIView.animateWithDuration(0.3, animations:layoutIfNeeded)
/// 
...
///
/// <code>label.bottomConstraint?.constant = 10
/// 
/// // Animate if needed
/// UIView.animateWithDuration(0.3, animations:layoutIfNeeded)
/// 
/// </code>
/// <code>- Returns: The bottom NSLayoutConstraint if found.
/// 
/// </code>
...
///
/// <code>label.heightConstraint?.constant = 10
///  
/// // Animate if needed
/// UIView.animateWithDuration(0.3, animations:layoutIfNeeded)
/// 
...
///
/// <code>Example Usage for changing width property of a label :
/// 
/// ```
