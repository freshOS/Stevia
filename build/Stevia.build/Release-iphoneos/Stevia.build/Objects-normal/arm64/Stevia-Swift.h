...
/**
  ...
  setTitle("MyText", forState: .Normal)
  \endcode
...
/**
  ...
  Essentially a shortcut for \code
  setTitle(NSLocalizedString("MyText", comment: "") , forState: .Normal)
  \endcode
...
/**
  ...
  Essentially a shortcut for \code
  setImage(UIImage(named:"X"), forState: .Normal)
  \endcode
...
/**
  ...
  Esentially, this is just a shortcut to \code
...
@interface UIView (SWIFT_EXTENSION(Stevia))
/**
  Adds the constraints needed for the view to fill its \code
  superview
  \endcode.
